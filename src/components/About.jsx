    ...
    <section name='about' className='w-full md:h-screen flex flex-col justify-center items-center bg-black px-6 py-6'>
        ...
        <div className='w-11/12 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-6'>
            ...
            <div className='border rounded p-6 hover:scale-105 duration-300 cursor-pointer'>
                ...
                <MdLocalHospital className='p-2 bg-blue-400 rounded-full text-white' size={45}/>
            ...
            <div className='border rounded p-6 hover:scale-105 duration-300 cursor-pointer'>
                ...
                <MdHotel className='p-2 bg-blue-400 rounded-full text-white' size={45} />
            ...
            <div className='border rounded p-6 hover:scale-105 duration-300 cursor-pointer'>
                ...
                <MdOutlineRestaurantMenu className='p-2 bg-blue-400 rounded-full text-white' size={45}/>
            ...
            <div className='border rounded p-6 hover:scale-105 duration-300 cursor-pointer'>
                ...
                <MdTour className='p-2 bg-blue-400 rounded-full text-white' size={45}/>
